...
class MainPage:
    ...
    def create_widgets(self):
        ...
        # item page button to show the item page
        ...
        # progress button to show the progress page
        ...
        # next steps button to show the next steps page
